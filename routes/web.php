...
Route::get('/houses/oneBedrooms', 'HomeController@oneBedrooms')->name('house.oneBedrooms');
Route::get('/houses/twoBedrooms', 'HomeController@twoBedrooms')->name('house.twoBedrooms');
Route::get('/houses/bedSitters','HomeController@bedSitters')->name('house.bedSitters');
Route::get('/houses/threeBedrooms', 'HomeController@threeBedrooms')->name('house.threeBedrooms');
Route::get('/houses/singles', 'HomeController@singles')->name('house.singles');
Route::get('/houses/similar', 'HomeController@similar')->name('house.similar');
...
//Route::get('/available-houses/house_type/{house_type}','HomeController@houseType')->name('available.house_type.house');
